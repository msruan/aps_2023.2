...
namespace prova.Controllers
{
    public class PagamentosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoDePagamentoId"] = new SelectList(_context.TiposDePagamento, "TipoDePagamentoId", "Discriminator");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PagamentoId,DataLimite,Valor,Pago,NotaDeVendaId,TipoDePagamentoId")] Pagamento pagamento)
        {
            ...
            ViewData["TipoDePagamentoId"] = new SelectList(_context.TiposDePagamento, "TipoDePagamentoId", "Discriminator", pagamento.TipoDePagamentoId);
            return View(pagamento);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PagamentoId,DataLimite,Valor,Pago,NotaDeVendaId,TipoDePagamentoId")] Pagamento pagamento)
        {
