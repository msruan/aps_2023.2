...
dotnet-aspnet-codegenerator controller -name TiposDePagamentoController -m TipoDePagamento -dc MyDbContext --relativeFolderPath Controllers --useDefaultLayout --referenceScriptLibraries 
...
dotnet-aspnet-codegenerator controller -name NotasDeVendaController -m NotaDeVenda -dc MyDbContext --relativeFolderPath Controllers --useDefaultLayout --referenceScriptLibraries  
